...
slug: expo-app-config
canonicalPath: /2023/02/01/expo-app-config.html
summary: Expo is a free and open-source platform for creating and building mobile apps using...
draft: false
hasDetailPage: true
featured: false
tags:
...
comments: true
preservedHeadingIds:
  - converting-to-appjson-to-appconfigjs-for-multiple-environments
  - appconfigjs
  - easjson
  - passing-environment-variables-to-eas-update
numberHeadings: false
originalTimestamp: "2023-02-01T04:22:25.000Z"
---
...
## Converting to app.json to app.config.js for multiple environments. {#converting-to-appjson-to-appconfigjs-for-multiple-environments}
...
## Passing Environment Variables to EAS Update {#passing-environment-variables-to-eas-update}
